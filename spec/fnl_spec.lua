describe("functional module", function()
  ...
  describe("filter function", function()
    it("should filter sequence by a given predicate", function()
      assert.are.same(
        ...
        fnl{1, 2, 3, 4, 5, 6, 7, 8}:filter(function(k, v) return v % 2 == 0 end)
      )
    end)
  end)
  ...
  describe("future features", function()
    ...
    describe("syntax", function()
      it("works", function()
        local seq = fnl.future{1, 2, 3, 4, 5, a=4}:filter(function(k, v) return v % 2 == 0 end)
        assert.are.same({nil, 2, nil, 4, nil, a=4}, seq)
      end)
    end)
  end)
end)
